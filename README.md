...
- The trajectory is color-coded by **linear velocity**, highlighting how the learned policy adjusts speed based on the robot’s state relative to the path (including the ``nearest``and ``lookahead`` points).
