...
if __name__ == '__main__':
    ...
    parser.add_argument("--disp_animation", action="store_true")               # Display animation 
    parser.add_argument("--save_animation", action="store_true")               # Save animation 
    ...
    if args.disp_animation:   
        ...
        plt.subplots(1)
        plt.plot(state.t[1::], state.v_ref[1::], "k--", lw=2)
        ...
        plt.subplots(1)
        plt.plot(state.t[1::], state.omega_ref[1::], "k--", lw=2)
